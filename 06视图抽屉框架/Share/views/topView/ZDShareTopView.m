...
- (void)setupSubViews{
    ...
    iconImage.imageView.layer.cornerRadius = 2;
    ...
    shareTime.font = [UIFont systemFontOfSize:13];
...
- (void)setShareFrame:(ZDShareFrame *)shareFrame{
    ...
    NSURL *url = [NSURL URLWithString:statusesModel.icon];
    ...
    [imageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"lol"] completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
        ...
        [self.iconImage setImage:userImage forState:UIControlStateNormal];
    }];
